...
import { getFuarBySlug, getAllFuarSlugs } from '@/lib/fuar'
...
export async function generateMetadata({ params }) {
  ...
  const fuar = await getFuarBySlug(resolvedParams.slug)
  return {
    title: `${fuar.title} - ${fuar.city}, ${fuar.country} | SetTravel UK`,
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
            ...
            <div className="bg-white rounded-lg shadow-md p-6">
              ...
              <p className="text-gray-600">
                ...
                {fuar.startDate !== fuar.endDate && (
                  <> - <br />{endDate.toLocaleDateString('en-GB', { day: 'numeric', month: 'long', year: 'numeric' })}</>
                )}
              </p>
              {fuar.frequency && (
            ...
            {fuar.website && (
              <div className="bg-white rounded-lg shadow-md p-6">
                ...
                <a
                  ...
                  style={{ color: '#ee7d21' }}
                  onMouseEnter={(e) => e.currentTarget.style.color = '#df5c17'}
                  onMouseLeave={(e) => e.currentTarget.style.color = '#ee7d21'}
                >
                  Visit Website →
                </a>
              </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
            ...
            <div className="lg:col-span-2">
              ...
              <div className="prose prose-lg max-w-none prose-headings:text-gray-900 prose-p:text-gray-600 prose-strong:text-gray-900" style={{ '--tw-prose-links': '#ee7d21' }}>
                <DocumentRenderer document={fuar.content} />
              </div>
