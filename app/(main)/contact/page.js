            ...
            <div>
              ...
              <div className="space-y-6">
                ...
                <div className="flex items-start">
                  <div className="flex-shrink-0">
                    <div className="w-12 h-12 rounded-lg flex items-center justify-center" style={{ backgroundColor: 'rgba(238, 125, 33, 0.1)' }}>
                      <svg className="w-6 h-6" style={{ color: '#ee7d21' }} fill="currentColor" viewBox="0 0 24 24">
                  ...
                  <div className="ml-4">
                    ...
                    <a href="https://www.instagram.com/fuarkutusu" target="_blank" rel="noopener noreferrer" className="text-gray-600 hover:opacity-80 transition-opacity">
                      @fuarkutusu
                    </a>
                  </div>
                </div>
