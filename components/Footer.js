    ...
    <footer className="bg-primary-900 text-gray-300">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm">
              ...
              <li className="flex space-x-4 mt-4">
                ...
                <a href="https://www.facebook.com/profile.php?id=61583591497055" target="_blank" rel="noopener noreferrer" className="hover:text-accent-400 transition-colors">
        ...
        <div className="border-t border-primary-800 mt-8 pt-8 text-sm text-center">
          <p>&copy; {new Date().getFullYear()} Fuar Kutusu. {t('footer.allRightsReserved', language)}</p>
        </div>
      </div>
    </footer>
  )
